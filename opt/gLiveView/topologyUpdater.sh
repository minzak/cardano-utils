...
CNODE_HOSTNAME="relay1-ada.bizlevel.net"  # (Optional) Must resolve to the IP you are requesting from
...
CUSTOM_PEERS="core1-ada.bizlevel.net,3000|core2-ada.bizlevel.net,3000|relay2-ada.bizlevel.net,3002"
